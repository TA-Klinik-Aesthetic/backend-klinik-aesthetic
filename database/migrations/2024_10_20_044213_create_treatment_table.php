...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('tb_booking_treatment', function (Blueprint $table) {
            ...
            $table->dateTime('treatment_mulai')->nullable();
            $table->dateTime('treatment_selesai')->nullable();
            $table->unsignedInteger('id_dokter')->nullable();
            $table->unsignedInteger('id_beautician')->nullable();
            $table->enum('status_booking_treatment', ['Verifikasi', 'Berhasil dibooking', 'Treatment dimulai', 'Dibatalkan', 'Selesai'])->default('Verifikasi')->nullable();
